import { PostForcedChangePassword, PostResetPassword } from 'services/security/endpoints/AuthService';
...
import { ForcedChangePasswordBody } from 'services/security/interfaces/AuthInterface';
    ...
    const handleSavePassword = async () => {
        ...
        if (password === repeatPassword) {
            if (Object.values(validations).every(Boolean)) {
                try {
                    const body:ForcedChangePasswordBody = {
                        email: email,
                        temporalPassword: currentPassword,
                        newPassword: password
                    };
                    await PostForcedChangePassword(body);
